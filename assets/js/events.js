/* Auto-generated from src/events.html by build/build.mjs — do not edit directly. */
(function () {
...
function EventsHero() {
  return /*#__PURE__*/React.createElement("section", {
    ...
    src: P + "/natalie-bruce-social-divers-boat-edge.jpg",
    alt: "Natalie Bruce and freediving teammates sitting on the edge of the dive boat in open water",
    style: {
      position: 'absolute',
      inset: 0,
      width: '100%',
    ...
    style: {
      position: 'absolute',
      inset: 0,
      background: 'linear-gradient(to top, rgba(35,60,58,0.92) 0%, rgba(35,60,58,0.35) 55%, rgba(35,60,58,0.1) 100%)'
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'relative',
