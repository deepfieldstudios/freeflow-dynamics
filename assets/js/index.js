/* Auto-generated from src/index.html by build/build.mjs — do not edit directly. */
(function () {
...
function Hero() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    style: {
      ...
      padding: 'clamp(10rem,16vw,13rem) clamp(1.5rem,5vw,5rem) 4rem clamp(1.25rem,5vw,4rem)',
      position: 'relative',
      zIndex: 2,
  ...
  }, "Human Performance \xB7 Freediving Coach"), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontFamily: 'var(--ffd-font-display)',
      fontWeight: 500,
  ...
  }, "FLOW"), /*#__PURE__*/React.createElement("br", null), "DYNAMICS"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: 'var(--ffd-font-display)',
      fontStyle: 'italic',
    ...
    size: "lg",
    href: "programs.html"
  }, "Work with me"), /*#__PURE__*/React.createElement(Btn, {
    variant: "ghost",
    size: "lg",
    href: "events.html"
  }, "Workshops & events")), /*#__PURE__*/React.createElement("div", {
    style: {
      borderLeft: '1.5px solid var(--ffd-line-dark)',
      paddingLeft: '1.4rem',
      display: 'flex',
      flexDirection: 'column',
      gap: '1.2rem'
    ...
    style: {
      ...
      borderRadius: '50%',
      background: 'var(--ffd-deep-tide-2)',
      border: '1.5px solid var(--ffd-tide-light)'
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
...
function About() {
  return /*#__PURE__*/React.createElement("section", {
    ...
    src: `${PHOTOS}/natalie-bruce-about-portrait-headshot.jpg`,
    alt: "Close-up portrait of Natalie Bruce, US professional freediver and coach",
    style: {
      width: '100%',
      aspectRatio: '3/4',
      objectFit: 'cover',
  ...
  }, "Photo: 2022"), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      bottom: '-2.5rem',
      right: '-2.5rem',
      ...
      borderRadius: 'var(--ffd-radius)',
      overflow: 'hidden',
      boxShadow: 'var(--ffd-shadow-lg)',
      border: '3px solid var(--ffd-shell)'
    }
  }, /*#__PURE__*/React.createElement("img", {
    src: `${PHOTOS}/natalie-bruce-about-meditation-rocks-tenerife.jpg`,
    alt: "Natalie Bruce in meditation on volcanic rock above the sea in Tenerife",
    style: {
      width: '100%',
      aspectRatio: '1',
      objectFit: 'cover'
...
function InTheWater() {
  return /*#__PURE__*/React.createElement("section", {
    ...
    src: `${PHOTOS}/natalie-bruce-competition-descent-safety-divers.jpg`,
    alt: "Natalie Bruce ascending the line between two safety divers in deep blue open water",
    style: {
      position: 'absolute',
      inset: 0,
      width: '100%',
    ...
    style: {
      position: 'absolute',
      inset: 0,
      background: 'linear-gradient(90deg, rgba(35,60,58,0.92) 0%, rgba(35,60,58,0.65) 55%, rgba(35,60,58,0.2) 100%)'
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'relative',
  ...
  }, "In competition"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: 'var(--ffd-font-display)',
      fontWeight: 400,
  ...
  }, "Safety on the line.", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("em", {
    style: {
      color: 'var(--ffd-tide-light)'
    }
  }, "Calm on the surface.")), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '1rem',
  ...
  }, "Competing at AIDA & CMAS events worldwide. Safety, preparation, and a trained mind \u2014 the practice begins long before the dive."), /*#__PURE__*/React.createElement(Btn, {
    variant: "secondary",
    href: "#programs"
  }, "Train with Natalie")));
}
...
function Programs() {
  const programs = [{
    tag: 'Pool training',
    tv: 'rgba(89,174,195,0.18)',
    tc: 'var(--ffd-tide-deep)',
    title: 'Pool Only Trainings',
    dur: '$175 / month',
    desc: 'Learn to meet the water with a calmer mind. Breathwork, equalisation, technique, and the mindfulness practices that underpin everything.',
    items: ['Breathwork fundamentals', 'Frenzel & Mouthfill equalisation', 'Safety protocols', 'Weekly live sessions'],
    cta: 'Book this program',
    dark: false,
    img: `${PHOTOS}/natalie-bruce-coaching-pool-dynamic-orca.jpg`,
    imgAlt: 'Natalie Bruce performing dynamic pool freediving training',
    imgPos: 'center 42%'
  }, {
    tag: 'Full performance',
    tv: 'rgba(188,145,119,0.2)',
    tc: 'var(--ffd-cocoa)',
    title: 'Full Performance Package',
    dur: '$275 / month',
    desc: 'For divers ready to go deeper. Structured depth training, mental performance tools, and race-level preparation for AIDA competition.',
    items: ['Depth & discipline training', 'Mental performance tools', 'Competition preparation', 'Video analysis feedback'],
    cta: 'Book this program',
    dark: true,
    img: `${PHOTOS}/natalie-bruce-competition-surface-recovery.jpg`,
    imgAlt: 'Natalie Bruce surfacing after a competition dive with safety divers nearby'
  }, {
    tag: '1:1',
    tv: 'rgba(136,153,109,0.18)',
    tc: '#5a6b45',
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    key: i,
    style: {
      background: p.dark ? 'var(--ffd-deep-tide)' : 'var(--ffd-foam)',
      border: `1px solid ${p.dark ? 'var(--ffd-line-dark)' : 'var(--ffd-line)'}`,
      borderRadius: 'var(--ffd-radius-lg)',
      overflow: 'hidden',
    ...
    onMouseEnter: e => {
      ...
      e.currentTarget.style.boxShadow = 'var(--ffd-shadow-lg)';
    },
    onMouseLeave: e => {
      e.currentTarget.style.transform = 'none';
      e.currentTarget.style.boxShadow = 'var(--ffd-shadow)';
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      height: 212,
    ...
    style: {
      ...
      height: '100%',
      objectFit: 'cover',
      objectPosition: p.imgPos || 'center 30%'
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      inset: 0,
      background: p.dark ? 'rgba(35,60,58,0.35)' : 'rgba(242,235,220,0.12)'
    }
  }), /*#__PURE__*/React.createElement("span", {
    style: {
      position: 'absolute',
    ...
    style: {
      ...
      fontSize: '1.3rem',
      letterSpacing: '-0.01em',
      color: p.dark ? 'var(--ffd-foam)' : 'var(--ffd-ink)',
      lineHeight: 1.2
    }
    ...
    style: {
      fontFamily: 'var(--ffd-font-metric)',
      fontSize: '0.76rem',
      color: p.dark ? 'var(--ffd-mist)' : 'var(--ffd-stone-soft)',
      flexShrink: 0,
      marginLeft: '0.5rem'
    }
  }, p.dur)), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '0.88rem',
      color: p.dark ? 'rgba(183,205,203,0.82)' : 'var(--ffd-stone)',
      lineHeight: 1.62,
      marginBottom: '1rem',
      flex: 1
    }
  ...
  }, p.items.map((item, j) => /*#__PURE__*/React.createElement("li", {
    key: j,
    style: {
      fontSize: '0.83rem',
      color: p.dark ? 'var(--ffd-tide-light)' : 'var(--ffd-tide-deep)',
      display: 'flex',
      gap: '0.5rem'
    }
  }, /*#__PURE__*/React.createElement("span", {
    ...
    variant: p.dark ? 'secondary' : 'primary',
    href: BOOKING_URL,
    onClick: openBooking,
    style: {
      width: '100%',
...
function PhotoStrip() {
  const photos = [{
    src: `${PHOTOS}/natalie-bruce-social-waterline-surface-float.jpg`,
    alt: 'Natalie Bruce floating at the surface on the line between dives, coastline behind',
    credit: '2025'
  }, {
    src: `${PHOTOS}/natalie-bruce-about-portrait-orca-coast.jpg`,
    alt: 'Natalie Bruce smiling in an Orca wetsuit on a tropical coastline',
    credit: '2026'
  }, {
    src: `${PHOTOS}/natalie-bruce-social-baitball-boat-silhouette.jpg`,
    alt: 'Underwater view of the dive boat silhouetted against a baitball of fish',
    credit: '2025'
  }, {
    src: `${PHOTOS}/natalie-bruce-about-yoga-coast-tenerife.jpg`,
    alt: 'Natalie Bruce in a yoga side-angle pose on volcanic rock by the sea in Tenerife',
    credit: 'Tenerife 2023'
  }, {
    src: `${PHOTOS}/natalie-bruce-atmosphere-rockpool-reflection.jpg`,
    alt: 'Reflection of Natalie Bruce in a still tide pool among volcanic rock in Tenerife',
    credit: '@monalisa.fiedler'
  }];
  return /*#__PURE__*/React.createElement("section", {
    style: {
    ...
    style: {
      ...
      background: 'linear-gradient(to top, rgba(51,50,44,0.7), transparent)'
    }
  }, /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '0.62rem',
...
function Quotes() {
  const qs = [{
    text: 'If you look at zero, you see nothing; but look through it and you will see the world.',
    attr: 'Robert Kaplan',
    src: 'The Nothing That Is'
  }, {
    text: 'The human body at peace with itself is more precious than the rarest gem.',
    attr: 'Je Tsongkhapa',
    src: '1357–1419'
  }, {
  ...
  }, "The lineage"), /*#__PURE__*/React.createElement("h2", {
    style: {
      fontFamily: 'var(--ffd-font-display)',
      fontWeight: 500,
  ...
  }, "Borrowed voices,", /*#__PURE__*/React.createElement("br", null), "always attributed."), /*#__PURE__*/React.createElement("div", null, qs.map((q, i) => /*#__PURE__*/React.createElement("div", {
    key: i
  }, /*#__PURE__*/React.createElement("blockquote", {
    style: {
      padding: '2rem 0',
  ...
  }, String(i + 1).padStart(2, '0')), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: 'var(--ffd-font-display)',
      fontStyle: 'italic',
  ...
  }, "\"", q.text, "\""), /*#__PURE__*/React.createElement("cite", {
    style: {
      fontStyle: 'normal',
      fontFamily: 'var(--ffd-font-body)',
      fontSize: '0.7rem',
  ...
  }, q.attr, q.src ? ` · ${q.src}` : ''))), i < qs.length - 1 && /*#__PURE__*/React.createElement(Waterline, {
    dark: true
  }))))));
}
...
function Footer() {
  return /*#__PURE__*/React.createElement("footer", {
    ...
    src: `${PHOTOS}/natalie-bruce-atmosphere-sunset-coast.jpg`,
