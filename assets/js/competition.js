/* Auto-generated from src/competition.html by build/build.mjs — do not edit directly. */
(function () {
...
function CompHero() {
  return /*#__PURE__*/React.createElement("section", {
    ...
    style: {
      position: 'absolute',
      inset: 0,
      background: 'linear-gradient(to top, rgba(35,60,58,0.72) 0%, rgba(35,60,58,0.2) 22%, rgba(35,60,58,0) 40%)'
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'relative',
  ...
  }, "Competition"), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontFamily: 'var(--ffd-font-display)',
      fontWeight: 500,
  ...
  }, "12\xD7 continental.", /*#__PURE__*/React.createElement("br", null), "17\xD7 US national."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '1rem',
      color: 'rgba(183,205,203,0.8)',
      fontWeight: 300,
      maxWidth: '44ch',
      lineHeight: 1.65
    }
...
function Bar({
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: '118px 1fr 116px',
      gap: '1rem',
      alignItems: 'center'
    }
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
  ...
  }, code), natRank === 1 && /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--ffd-font-body)',
      fontWeight: 500,
      fontSize: '0.5rem',
      ...
      textTransform: 'uppercase',
      color: 'var(--ffd-gold)',
      border: '1px solid rgba(229,176,80,0.45)',
      borderRadius: 3,
      padding: '0.12rem 0.32rem',
      whiteSpace: 'nowrap'
    }
  }, "US #1")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '0.6rem',
      letterSpacing: '0.1em',
      textTransform: 'uppercase',
    ...
    style: {
      ...
      height: 16,
      borderRadius: 8,
      background: 'rgba(89,174,195,0.1)'
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      height: '100%',
      width: grown ? `${pct}%` : '0%',
      borderRadius: 8,
      background: accent || 'linear-gradient(90deg, var(--ffd-tide-deep), var(--ffd-tide))',
      transition: 'width 1.3s cubic-bezier(.16,1,.3,1)',
      boxShadow: '0 0 18px -4px rgba(89,174,195,0.5)'
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
  ...
  }, pb, unit), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '0.58rem',
  ...
  }, ofWr, "% of WR \xB7 #", worldRank, " world")));
}
function TheRecord() {
  ...
  // Personal bests (m) vs women's world record (m), with world & US-national rankings — via freedivingranking.com / AIDA / CMAS
  const pool = [{
    code: 'DYNB',
  ...
  const stats = [{
    v: 'No. 7',
    l: 'World ranking · pool & depth'
  }, {
    v: 'US #1',
    l: 'DYN · DYNB · DNF'
  }, {
    v: '2×',
    l: '2025 World C’ship medals'
  }, {
    v: '200 m',
    l: 'First US woman, pool'
  }];
  return /*#__PURE__*/React.createElement("section", {
    ref: ref,
    style: {
  ...
  }, "On the board"), /*#__PURE__*/React.createElement("h2", {
    style: {
      fontFamily: 'var(--ffd-font-display)',
      fontWeight: 500,
  ...
  }, "The record,", /*#__PURE__*/React.createElement("br", null), "in numbers.")), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '1rem',
  ...
  }, "Personal bests across eight competitive disciplines, drawn from AIDA International, CMAS, and the global Freedive Ranking. Each bar is her best in metres \u2014 the gold line is the women's world record, so you can see how close.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, "Pool \u2014 distance on one breath"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--ffd-font-metric)',
      fontSize: '0.66rem',
      color: 'var(--ffd-stone-soft)'
    }
  }, "metres")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: '1.9rem'
  ...
  }, "STA"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '0.6rem',
      letterSpacing: '0.1em',
      textTransform: 'uppercase',
  ...
  }, "Static apnea")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '0.78rem',
      color: 'rgba(183,205,203,0.7)',
      fontWeight: 300
    }
  }, "Breath hold \u2014 held still, no distance"), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'right'
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Depth \u2014 metres on one breath"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--ffd-font-metric)',
      fontSize: '0.66rem',
      color: 'var(--ffd-stone-soft)'
  ...
  }, depth.map((p, i) => /*#__PURE__*/React.createElement(Bar, _extends({
    key: i
  }, p, {
    max: 130,
    unit: "m",
    grown: grown,
    accent: "linear-gradient(90deg, var(--ffd-slate), var(--ffd-tide-deep))"
  ...
  }, "Gold line = women's world record \xB7 gold badge = US national No. 1. Personal bests, rankings and records via freedivingranking.com, AIDA International & CMAS.")));
}
function SeasonForm() {
  const timeline = [{
    year: '2024',
    title: 'First American woman to 200 m',
    detail: 'Dynamic pool — 200 m covered on a single breath, a first for any US female freediver.'
  }, {
    year: '2024',
    title: 'North American record · DYN 231 m',
    detail: 'Set at the 32nd AIDA Pool World Championship.'
  }, {
    year: '2025',
    title: 'Bronze medal · DYN 257 m',
    detail: '2025 AIDA World Championships, Wakayama — and a new North American continental record.'
  }, {
    year: '2025',
    title: 'Vice-World Champion · DYNB 249 m',
    detail: '2025 AIDA World Championships, Wakayama — silver in dynamic bi-fins, past the previous world-record mark.'
  }, {
    year: '2026',
    title: 'Ranked World No. 7',
    detail: 'Current global standing across pool and depth disciplines.'
  }];
  return /*#__PURE__*/React.createElement("section", {
    style: {
      background: 'var(--ffd-foam)',
  ...
  }, "Recent form"), /*#__PURE__*/React.createElement("h2", {
    style: {
      fontFamily: 'var(--ffd-font-display)',
      fontWeight: 500,
  ...
  }, "Two seasons,", /*#__PURE__*/React.createElement("br", null), "still rising."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '1.02rem',
      color: 'var(--ffd-stone)',
      fontWeight: 300,
  ...
  }, "From a first 200-metre swim to a world-championship silver and bronze \u2014 the dynamic line keeps moving. Dynamic with fins climbed from 231 m to 257 m in a single year."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '2.5rem'
    }
  ...
  }, "231", /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '1rem'
    }
  ...
  }, "DYN \xB7 2024")), /*#__PURE__*/React.createElement("div", {
    style: {
      alignSelf: 'center',
      fontFamily: 'var(--ffd-font-metric)',
      color: 'var(--ffd-clay)',
  ...
  }, "\u2192 +26m"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: 'var(--ffd-font-metric)',
      fontSize: '1.9rem',
      color: 'var(--ffd-deep-tide)',
  ...
  }, "257", /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '1rem'
    }
  }, "m")), /*#__PURE__*/React.createElement("div", {
  ...
  }, "DYN \xB7 2025")))), /*#__PURE__*/React.createElement("div", {
    style: {
      borderLeft: '1.5px solid var(--ffd-line)',
      paddingLeft: '2rem',
      display: 'flex',
      flexDirection: 'column',
      gap: '2.2rem'
...
function EventGallery() {
  const photos = [{
    src: `${P}/natalie-bruce-competition-line-rigging.jpg`,
    alt: 'Natalie Bruce rigging the competition line and bottom plate underwater',
    cap: 'Setting the line'
  }, {
    src: `${P}/natalie-bruce-competition-descent-safety-divers.jpg`,
    alt: 'Natalie Bruce descending with safety divers watching on either side',
    cap: 'Down the line — safeties watching'
  }, {
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, "In the water"), /*#__PURE__*/React.createElement("h2", {
    style: {
      fontFamily: 'var(--ffd-font-display)',
      fontWeight: 500,
  ...
  }, "Competition is the practice, made public."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
    ...
    style: {
      ...
      background: 'linear-gradient(to top, rgba(35,60,58,0.7), transparent)'
    }
  }, /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '0.68rem',
...
function WhatIsAIDA() {
  const disciplines = [{
    code: 'CWT',
    name: 'Constant Weight',
    desc: 'The athlete descends and ascends using fins or a monofin along a vertical rope, without pulling on the rope or changing ballast. Considered the purest test of freediving depth.'
  }, {
    code: 'CNF',
    name: 'Constant Weight No Fins',
    desc: 'The same discipline but without fins — the athlete uses only arm strokes and a dolphin kick. The most physically demanding depth discipline.'
  }, {
    code: 'STA',
    name: 'Static Apnea',
    desc: 'The athlete floats face-down in the water holding their breath for as long as possible. A test of relaxation, mental control, and physiological response.'
  }, {
    code: 'DYN',
    name: 'Dynamic with Fins',
    desc: 'The athlete swims horizontally in a pool, covering as much distance as possible on a single breath. Combines technique, efficiency, and mental endurance.'
  }];
  return /*#__PURE__*/React.createElement("section", {
    style: {
      background: 'var(--ffd-foam)',
  ...
  }, "The disciplines"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: '1fr 1fr',
      gap: '2rem 5rem',
  ...
  }, "What AIDA freediving actually involves."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '1.02rem',
      color: 'var(--ffd-stone)',
      fontWeight: 300,
  ...
  }, "AIDA International is the governing body for competitive freediving. Every record is verified by judges, filmed, and submitted for ratification. The sport spans depth, time, and distance disciplines \u2014 each demanding a different relationship with breath and stillness.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: 'repeat(2,1fr)',
      gap: '1px',
      background: 'var(--ffd-line)',
      borderRadius: 'var(--ffd-radius-lg)',
      overflow: 'hidden',
      border: '1px solid var(--ffd-line)'
    }
  }, disciplines.map((d, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      background: 'var(--ffd-foam)',
      padding: '2rem 2.2rem'
  ...
  }, d.code), /*#__PURE__*/React.createElement("h3", {
    style: {
      fontFamily: 'var(--ffd-font-display)',
      fontWeight: 500,
      fontSize: '1.15rem',
...
function CompCTA() {
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, "Train for competition."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '1rem',
      color: 'rgba(183,205,203,0.72)',
      fontWeight: 300,
      lineHeight: 1.65,
      marginBottom: '2rem'
    }
  }, "The Performance program is built for divers preparing to compete. A structured 12-week block with Natalie."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '0.8rem',
      justifyContent: 'center',
    ...
    size: "lg",
    href: "programs.html"
  }, "Performance program"), /*#__PURE__*/React.createElement(Btn, {
    variant: "ghost",
    href: BOOKING_URL,
    onClick: openBooking
  }, "Get in touch"))));
...
function App() {
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Nav, null), /*#__PURE__*/React.createElement("main", null, /*#__PURE__*/React.createElement(CompHero, null), /*#__PURE__*/React.createElement(TheRecord, null), /*#__PURE__*/React.createElement(SeasonForm, null), /*#__PURE__*/React.createElement(EventGallery, null), /*#__PURE__*/React.createElement(AtmosphereDivider, null), /*#__PURE__*/React.createElement(WhatIsAIDA, null), /*#__PURE__*/React.createElement(CompCTA, null)), /*#__PURE__*/React.createElement(Footer, null));
}
